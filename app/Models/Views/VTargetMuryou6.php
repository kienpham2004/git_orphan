...
class VTargetMuryou6 extends AbstractModel {
    // テーブル名
    protected $table = 'v_tenken_muryou6';
    ...
    public function scopeJoinCustomer( $query ) {
        $query->leftJoin(
            'tb_customer',
            function( $join ){
                $join->on( 'v_tenken_muryou6.car_manage_number', '=', 'tb_customer.car_manage_number' )
    ...
    public static function findTarget( $from, $to ) {
        // 他のテーブルとJOIN
        $builderObj = VTargetMuryou6::joinCustomer();
