...
class VTargetHoutei12 extends AbstractModel {
    // テーブル名
    protected $table = 'v_tenken_houtei_12';
    ...
    public function scopeJoinCustomer( $query ) {
        $query->leftJoin(
            'tb_customer',
            function( $join ){
                $join->on( 'v_tenken_houtei_12.car_manage_number', '=', 'tb_customer.car_manage_number' )
    ...
    public static function findTarget( $from, $to ) {
        // 他のテーブルとJOIN
        $builderObj = VTargetHoutei12::joinCustomer();
