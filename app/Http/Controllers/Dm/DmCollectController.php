...
use App\Commands\Dm\Collect\SumBaseCommand;
use App\Commands\Dm\Collect\SumUserCommand;
use App\Commands\Dm\Collect\SumBaseCsvCommand;
...
class DmCollectController extends Controller {
    ...
    public function initDisplayObj(){
        ...
        // コントローラー名
        $this->displayObj->ctl = "Dm\DmCollectController";
        // CSVファイル名
    ...
    public function extendSearchParams(){
        ...
        // 発送月を指定
        $search["inspection_ym_from"] = date("Ym", strtotime(date("Y-m-01"). "+1 month"));
