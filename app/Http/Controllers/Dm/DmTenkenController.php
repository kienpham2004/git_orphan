...
use App\Commands\Dm\Dm\ListTenkenCommand;
...
class DmTenkenController extends Controller{
    ...
    public function initDisplayObj(){
        ...
        // 画面名
        $this->displayObj->page = "dm_tenken";
        // 基本のテンプレート
        $this->displayObj->tpl = $this->displayObj->category . "." . $this->displayObj->page;
        // コントローラー名
        $this->displayObj->ctl = "Dm\DmTenkenController";
    }
