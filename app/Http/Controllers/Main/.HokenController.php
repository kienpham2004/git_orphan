...
//use App\Commands\Main\Hoken\ListCommand;
//use App\Commands\Main\Hoken\ListCsvCommand;
//use App\Http\Requests\SearchRequest;
//use App\Http\Controllers\Controller;
//use App\Http\Controllers\tInitSearch;
//use App\Http\Controllers\tEdit;
//
//class HokenController extends Controller{
//
...
//        // 画面名
//        $this->displayObj->page = "hoken";
//        // 基本のテンプレート
//        $this->displayObj->tpl = $this->displayObj->category . "." . $this->displayObj->page;
//        // コントローラー名
//        $this->displayObj->ctl = "Main\HokenController";
//        // 出力するcsvファイル名
...
//        $sort = [ Insurance::getTableName() . '.insu_car_manage_number' => 'asc' ];
//
//        return $sort;
//    }
//
...
//
//        // デフォルトに当月を指定
//        $search['insu_shipping_ym_from'] = $this->selectedYm();
//        $search['insu_shipping_ym_to'] = $this->selectedYm();
//
//        return $search;
//    }
//
