...
use App\Commands\Mut\DmHanyou\ListCommand;
use App\Commands\Mut\DmHanyou\ListCsvCommand;
...
class DmHanyouController extends Controller {
    ...
    public function initDisplayObj(){
        ...
        // 画面名
        $this->displayObj->page = "dm_hanyou";
        // 基本のテンプレート
        $this->displayObj->tpl = $this->displayObj->category . "." . $this->displayObj->page;
        // コントローラー名
        $this->displayObj->ctl = "Mut\DmHanyouController";
        // 出力するcsvファイル名
    ...
    public function extendSortParams() {
        ...
        $sort = ['tb_customer_dm_1.base_code' => 'asc', 'tb_customer_dm_1.user_id' => 'asc'];
