...
//
//                // 拠点別の集計データの取得
//                $tmpData = collect( ResultDB::summaryBase( $this->search ) );
//
//                // 合計の値を取得する
//                $tmpTotalData = collect( ResultDB::summaryBase( $this->search, "total" ) )[0];
//
//                //拠点別集計データの各項目を加算
...
//                        //各拠点ごとに値を加算
//                        if( $baseData->base_code == $data->base_code ){
