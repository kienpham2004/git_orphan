...
use App\Models\Contact\ContactSatei;
 ...
 * 1件だけを取得
 */
class ExtractContactSateiCommand extends Command implements ShouldBeQueued{
    ...
    public function handle(){
        ...
        foreach( $contactValues as $data ){
            ...
            ContactSatei::updateOrCreate(
                [
                    'ctcsa_customer_code' => $data['ctcsa_customer_code'],
                    'ctcsa_contact_ym' => $data['ctcsa_contact_ym'],
                ],
                $data
            );
        }
        ...
        $sql = "    
                    WITH tmp_ctnw AS (
                            ...
                            (
                                ...
                                WHERE
                                    ( tb_contact_1.ctc_result_code = '41' OR tb_contact_1.ctc_result_code = '041' ) AND
                                    (
                                        ...
                                        (
                                            ...
                                            WHERE
                                                ( tb_contact_2.ctc_result_code = '41' OR tb_contact_2.ctc_result_code = '041' )    
                                            GROUP BY
                                                tb_contact_2.ctc_customer_code
                                        )
                                    )
                    ...
                    SELECT
                        ctc.ctc_user_id as ctcsa_user_id,
                        ctc.ctc_user_code_init as ctcsa_user_code_init,
                        ctc.ctc_customer_code as ctcsa_customer_code,
                        ctc.ctc_contact_date as ctcsa_contact_date,
                        ctc.ctc_contact_ym as ctcsa_contact_ym,
                        ctc.ctc_car_manage_number as ctcsa_car_manage_number,
                        trim( ctc.ctc_result_code ) as ctcsa_result_code,
                        ctc.ctc_result_name as ctcsa_result_name,
                        created_by,
                        updated_by
                    ...
                    WHERE
                        ...
                        ( ctc.ctc_result_code = '41' OR ctc.ctc_result_code = '041' ) AND
                        EXISTS
                        (
                            SELECT *
                            FROM tmp_ctnw ctnw 
